...
{
public:
  voHierarchicalClusteringHeatMapViewPrivate();
...
// --------------------------------------------------------------------------
// voHierarchicalClusteringHeatMapViewPrivate methods

// --------------------------------------------------------------------------
voHierarchicalClusteringHeatMapViewPrivate::voHierarchicalClusteringHeatMapViewPrivate()
{
  this->ChartView = 0;
  this->Chart= 0;
  this->Widget = 0;
...
// --------------------------------------------------------------------------
// voHierarchicalClusteringHeatMapView methods

// --------------------------------------------------------------------------
voHierarchicalClusteringHeatMapView::voHierarchicalClusteringHeatMapView(QWidget * newParent):
    Superclass(newParent), d_ptr(new voHierarchicalClusteringHeatMapViewPrivate)
{
}

// --------------------------------------------------------------------------
voHierarchicalClusteringHeatMapView::~voHierarchicalClusteringHeatMapView()
{
}

// --------------------------------------------------------------------------
void voHierarchicalClusteringHeatMapView::setupUi(QLayout *layout)
{
  Q_D(voHierarchicalClusteringHeatMapView);
...
// --------------------------------------------------------------------------
void voHierarchicalClusteringHeatMapView::setDataObject(voDataObject* dataObject)
{
  Q_D(voHierarchicalClusteringHeatMapView);

  if (!dataObject)
    {
    qCritical() << "voHierarchicalClusteringHeatMapView - Failed to setDataObject - dataObject is NULL";
    return;
    }
